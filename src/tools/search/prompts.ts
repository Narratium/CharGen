...
• Use specific details to make abstract concepts concrete`,
  ...
  // Evaluation prompts for search thinking
  SEARCH_EVALUATION_SYSTEM: `You are evaluating the quality of inspiration/research data generated by the SEARCH tool.
...
{{
  ...
  // Search improvement prompts
  SEARCH_IMPROVEMENT_SYSTEM: `You are providing improvement instructions for the SEARCH tool.
